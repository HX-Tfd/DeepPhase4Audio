...
from src.losses.loss import CrossEntropyLoss
...
from src.utils.constants import frames, input_channels


class MockExperiment(pl.LightningModule):
    N = frames
    D = input_channels
    model_input_shape = torch.Size((D, N)) # see PAE model description

    def __init__(self, cfg, **kwargs) -> None:
        super(MockExperiment, self).__init__()
        self.cfg = cfg
