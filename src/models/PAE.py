...
class PAE(nn.Module):
    # assumptions from the original paper:
    # input (motion curve) shape: (B x) D x N, where D = dof, The temporal data is divided into overlapping windows of length 𝑁
    # with corresponding centered time window T.
    ## original paper: N = 342248, D = 78
